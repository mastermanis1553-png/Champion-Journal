  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <MetricCard title="Net P&L (Post Fees)" value={`₹${Math.floor(safeNetPnl).toLocaleString()}`} sub="Realized Profit" color="text-emerald-500" />
      </div>
      ...
      {/* Execution logs hata diye aur Matrix component add kar diya */}
      <div className="mt-8 bg-white border border-[#d0bdf4] p-5 rounded-2xl shadow-sm">
         <MatrixTable />
      </div>
    </div>
  );
