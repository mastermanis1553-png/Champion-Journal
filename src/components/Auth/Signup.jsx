    ...
    <div className="min-h-screen bg-[#e5eaf5] flex flex-col items-center justify-center p-6 font-sans">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center flex flex-col items-center">
          ...
          <h2 className="text-3xl font-bold text-[#8458B3] tracking-tight uppercase">Request <span className="text-[#a28089]">Access</span></h2>
          <p className="text-[#a28089] text-sm font-medium mt-2">Create an account to track your trades.</p>
        </div>
        ...
        <div className="bg-white border border-[#d0bdf4] p-8 rounded-[2rem] shadow-sm">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-semibold text-[#a28089] uppercase tracking-widest ml-1">Create Password</label>
              <input 
                type="password" 
                required 
                className="w-full bg-[#f8f9fc] border border-[#e5eaf5] p-3.5 rounded-xl focus:border-[#a0d2eb] outline-none text-[#494D5F] font-semibold transition-colors" 
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-semibold text-[#a28089] uppercase tracking-widest ml-1">Confirm Password</label>
              <input 
                type="password" 
                required 
                className="w-full bg-[#f8f9fc] border border-[#e5eaf5] p-3.5 rounded-xl focus:border-[#a0d2eb] outline-none text-[#494D5F] font-semibold transition-colors" 
            ...
            <button type="submit" className="w-full bg-[#8458B3] hover:opacity-90 text-white font-bold py-4 rounded-xl shadow-md transition-opacity uppercase text-xs tracking-widest mt-4">
              Create Account
            </button>
          </form>
          ...
          <p className="text-center text-xs font-semibold text-[#a28089] mt-8">
            Already have an account? <Link to="/login" className="text-[#8458B3] hover:underline">Log in</Link>
          </p>
        </div>
      </div>
    </div>
